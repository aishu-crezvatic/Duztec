...
class About_hero extends CI_Controller

{
    public function __construct()
    {
        parent::__construct();
        $this->load->model('admin/about_hero_model');
    }

    public function index()
    {
        $data['data'] = $this->about_hero_model->fetch();

        $this->load->view('admin/home/about_hero', $data);
    }
...

    {
        ...
        // echo($id);
        // exit;
        $this->about_hero_model->delete($id);
    ...
    public function status($id)
    {
        ...
        $this->about_hero_model->status($id);
    }
}
