    ...
    <div class="container-fluid">
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Add Anka</h5>
                        <button type="button" class="close" data-dismiss="modal"><span>&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form method="post" action="<?php echo base_url() ?>admin/anka/create" enctype="multipart/form-data">
                            <div class="form-group">
                                <label>Upload PDF</label>
                                <div class="custom-file">
                                    <input name="upload_pdf" type="file" class="custom-file-input" accept=".pdf" multiple>
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-file">
                                    <input name="upload_pdf_image" type="file" class="custom-file-input" accept=".jpg,.png,.webp,.avif,.jpeg" multiple>
                                    <label class="custom-file-label selected">Choose File</label>
                                </div>
                            </div>
                            <div class="form-group">
                                <label> Anka Name</label>
                                <input name="anka-name" type="text" class="form-control" placeholder="Enter Name">
                            </div>
                            <div class="form-group">
                                <label> Anka alt Name</label>
                                <input name="anka-alt-name" type="text" class="form-control" placeholder="Enter Name">
                            </div>
                            <div class="form-group">
        ...
        <div class="row">
            ...
            <div class="col-12 mb-3">
                <a href="javascript:void(0)" class="btn btn-primary w-100 m-0" data-toggle="modal" data-target="#addOrderModalside">+ Add New Anka</a>
            </div>
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Anka Table</h4>
                    </div>
                    <div class="card-body">
                                ...
                                <table id="example3" class="display min-w850 dataTable no-footer" role="grid" aria-describedby="example3_info">
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="example3" rowspan="1" colspan="1" aria-label="Department: activate to sort column ascending" style="width: 182.703px;">PDF</th>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr role="row" class="odd">
                                                <td><?php echo $i; ?></td>
                                                <td>
                                                    <a href="<?php echo base_url() ?>uploads/pdf/<?php echo $row["anka-pdf"];  ?>">
                                                        <img style="width: 50px;" src="<?php echo base_url() ?>assets/images/pdf.png" alt="image">
                                                    </a>
                                                </td>
                                                <td>
                                                    <img style="width: 50px;" src="<?php echo base_url() ?>uploads/pdf/<?php echo $row["anka-image"];  ?>" alt="image">
                                                </td>
                                                <td><?php echo $row['anka-name'] ?></td>
                                                <td>
                                                    <div class="col-sm-9">
                                                        <input data-id="<?php echo $row['anka-id'] ?>" class="switch switchAnka" type="checkbox" <?php echo $row['status'] == 1 ? 'checked' : '' ?> onclick="switchAnka(<?php echo $row['anka-id'] ?>)"/>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="d-flex">
                                                        <a href="<?php echo base_url() ?>admin/anka/edit/<?php echo $row['anka-id']; ?>" data-id="<?php echo $row['anka-id'] ?>" class="btn btn-primary shadow btn-xs sharp mr-1 editbtn"><i class="fa fa-pencil"></i></a>
                                                        <a href="<?php echo base_url() ?>admin/anka/delete/<?php echo $row['anka-id']; ?>" class="btn btn-danger shadow btn-xs sharp deletebtn" onclick="confirm('You want to delete data ?');"><i class="fa fa-trash"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                        <?php
...
<!--**********************************footer End***********************************-->
<script>
    function switchAnka(id) {
        $.post(
            base_url + "admin/anka/status/" + id, {
                data: id
            },
            function(response) {
