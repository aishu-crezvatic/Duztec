                    ...
                    <div class="modal-body">
                        <form method="POST" action="<?php echo base_url() ?>admin/product/create" enctype="multipart/form-data">
                            <div class="form-group">
                                <label>Upload Image (200*250px)</label>
                                <div class="custom-file">
                                    <input name="image[]" type="file" class="custom-file-input" multiple accept=".jpg,.jpeg,.png,.webp,.avif">
                                        ...
                                        ?>
                                            <tr role="row" class="odd">
                                                ...
                                                <td>
                                                    ...
                                                    ?>
                                                        <img style="width: 50px;" src="<?php echo base_url() . "uploads/" . $baseimg ?>" alt="image">
                                                    <?php
                                                    }
                                                    ?>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="col-sm-9">
                                                        <input data-id="<?php echo $row['id'] ?>" class="switch switchProduct" type="checkbox" <?php echo $row['status'] == 1 ? 'checked' : '' ?> />
                                                    </div>
                                                </td>
                                                <td><?php echo date('d/m/Y', strtotime($row['created_at'])) ?></td>
                                                <td>
                                                    <div class="d-flex">
                                                        <a href="<?php echo base_url() ?>admin/product/edit/<?php echo $row['id'] ?>" data-id="<?php echo $row['id'] ?>" class="btn btn-primary shadow btn-xs sharp mr-1 editbtn"><i class="fa fa-pencil"></i></a>
