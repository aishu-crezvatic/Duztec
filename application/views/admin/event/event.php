            ...
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" action="<?php echo base_url() ?>admin/event/create" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <div class="custom-file">
                                        <input name="image" type="file" class="custom-file-input" accept=".avif,.webp,.jpg,jpeg,png" required>
                                        <label class="custom-file-label selected">Choose File</label>
                                    </div>
                                </div>
                                <div class="form-group col-12">
                                    <label>Url Title* (do not put "-")</label>
                                    <input name="url_title" type="text" class="form-control" placeholder="Enter Url Title" required>
                                </div>
                                <div class="form-group col-12">
                                    <label>Title*</label>
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <input name="meta_title" type="text" class="form-control" placeholder="Enter Title" required>
                                </div>
                                <div class="form-group col-12">
                                    <label>Meta Description*</label>
                                    <textarea class="form-control" name="meta_description" placeholder="Enter Title" required></textarea>
                                </div>
                                <div class="form-group col-12">
                                    <label>Meta Keyword*</label>
                                    <input name="meta_keyword" type="text" class="form-control" placeholder="Enter Title" required>
                                </div>
                                <div class="form-group col-12">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" action="<?php echo base_url() ?>admin/blog/edit" enctype="multipart/form-data">
                            ...
                            <div class="form-group col-12">
                                <label>Event Date*</label>
                                <input name="event_date" type="date" class="form-control editModaleventDate">
                            </div>
                            <div class="form-group">
        ...
        <div class="modal fade" id="deleteOrderModalside">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form method="POST" action="<?php echo base_url() ?>admin/event/delete" enctype="multipart/form-data">
                        <div class="modal-body">
                                ...
                                <table id="example3" class="display min-w850 dataTable no-footer" role="grid" aria-describedby="example3_info">
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="example3" rowspan="1" colspan="1" aria-label="Gender: activate to sort column ascending" style="width: 94.2344px;">Event Date</th>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr role="row" class="odd">
                                                <td><?php echo $i; ?></td>
                                                <td>
                                                    <img style="width: 150px;" class="blogbanner" src="<?php echo base_url() . "uploads/" . $row['image'] ?>" alt="banner">
                                                </td>
                                                <td class="title"><?php echo strlen($row['title']) > 50 ? substr($row['title'], 0, 50) . '...' : $row['title'] ?></td>
                                                <!-- <td class="description"><?php echo strlen($row['description']) > 50 ? substr($row['description'], 0, 50) . '...' : $row['description'] ?></td> -->
                                                <td class="description">content...</td>
                                                <td class="eventDate" data-date="<?php echo $row['event_date'] ?>"><?php echo date('d-F-Y', strtotime($row['event_date'])) ?></td>
                                                <td class=""><?php echo date('d-F-Y', strtotime($row['created_at'])) ?></td>
                                                <td>
                                                    <div class="d-flex">
                                                        <a href="<?php echo base_url() ?>admin/event/edit/<?php echo $row['id'] ?>" class="btn btn-primary shadow btn-xs sharp mr-1 eventeditbtn"><i class="fa fa-pencil"></i></a>
