            ...
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form method="POST" action="<?php echo base_url() ?>admin/blogcategory/create" enctype="multipart/form-data">

                            <div class="form-group">

                                <label class="text-black font-w500">Upload Image (100*100px)</label>
                            ...
                            <div class="form-group">
                                ...
                                <label class="text-black font-w500">Upload Banner (100*100px)</label>
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <label>URL Name* <span style="color: red;">(Do Not Put - or _ use space for sepration)</span></label>

                                    <input name="url_name" type="text" class="form-control" placeholder="Enter Url Name" required>
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form method="POST" action="<?php echo base_url() ?>admin/blogcategory/edit" enctype="multipart/form-data">

                            <input name="id" type="text" value="1" id="blogeditModalId" hidden>
                            ...
                            <div class="form-group">
                                ...
                                <img style="width:100px;" id="blogeditModalImage" class="my-2 border rounded" src="" alt="banner">
                            ...
                            <div class="form-group">
                                ...
                                <label class="text-black font-w500">Upload Banner (1800*750px)</label>

                                <br>

                                <img style="width:100px;" id="blogeditModalBanner" class="my-2 border rounded" src="" alt="banner">
                            ...
                            <div class="form-group col-12">
                                ...
                                <input name="name" type="text" class="form-control editModalname" placeholder="Enter Title" require>
                            ...
                            <div class="form-group col-12">
                                ...
                                <input name="url_name" type="text" class="form-control editModalUrlname" placeholder="Enter Url Name" required>
                            ...
                            <div class="form-group col-12">
                                ...
                                <textarea name="description" class="form-control editModalDescription summernote" cols="30" rows="10" placeholder="Enter Description" required></textarea>
        ...
        <div class="modal fade" id="deleteOrderModalside">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                <div class="modal-content">
                    ...
                    <form method="POST" action="<?php echo base_url() ?>admin/blogcategory/delete" enctype="multipart/form-data">
            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <h4 class="card-title">Blog Category Table</h4>
                                ...
                                <table id="example3" class="display min-w850 dataTable no-footer" role="grid" aria-describedby="example3_info">
                                    ...
                                    <thead>
                                        ...
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="example3" rowspan="1" colspan="1" aria-label="Department: activate to sort column ascending" style="width: 182.703px;">URL Name</th>
                                        ...
                                        ?>
                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td>
                                                    ...
                                                    <img style="width: 100px;border-radius:150px;" class="categoryImage" src="<?php echo base_url() . "uploads/" . $row['image'] ?>" alt="banner">

                                                </td>

                                                <td>
                                                    <img style="width: 150px;" class="categoryBanner" src="<?php echo base_url() . "uploads/" . $row['banner'] ?>" alt="banner">
                                                </td>

                                                <td class="categoryName"><?php echo $row['name'] ?></td>

                                                <td class="categoryUrlName"><?php echo $row['url_name'] ?></td>

                                                <td class="categoryDescription" data-content='<?php echo $row['description']; ?>'>content...</td>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        <a href="javascript:void(0)" class="btn btn-primary shadow btn-xs sharp mr-1 blogcategoryeditbtn" data-toggle="modal" data-target="#editOrderModalside" data-id="<?php echo $row['id'] ?>"><i class="fa fa-pencil"></i></a>
