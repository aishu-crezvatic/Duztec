    ...
    <div class="container-fluid">
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title">Add Story Audio</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <form method="POST" action="<?php echo base_url() ?>admin/audio/addstory" enctype="multipart/form-data">

                            <div class="form-group">

                                <label class="text-black font-w500">Upload Image (100x100px)*</label>
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <div class="custom-file">
                                        ...
                                        <input name="file0" type="file" accept=".jpg,.jpeg,.png,.avif,.webp" class="custom-file-input" required>
                                ...
                                <label class="text-black font-w500">Upload Audio File*</label>
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <div class="custom-file">
                                        ...
                                        <input name="file1" type="file" accept=".mp3,audio/*" class="custom-file-input" required>
                            ...
                            <div class="form-group">
                                ...
                                <button name="submit" type="submit" class="btn btn-primary btn-block">Create Audio Story</button>
        ...
        <div class="modal fade" id="deleteOrderModalside">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                <div class="modal-content">
                    ...
                    <form method="POST" action="<?php echo base_url() ?>admin/audio/deleteaudio" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-12 mb-3">
                ...
                <a href="javascript:void(0)" class="btn btn-primary w-100 m-0" data-toggle="modal" data-target="#addOrderModalside">+ New Story Audio</a>
            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <h4 class="card-title">Audio Table</h4>
                                ...
                                <table id="example3" class="display min-w850 dataTable no-footer" role="grid" aria-describedby="example3_info">
                                    ...
                                    <thead>
                                        ...
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="example3" rowspan="1" colspan="1" aria-label="Department: activate to sort column ascending" style="width: 182.703px;">Audio</th>
                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td>
                                                    ...
                                                    <audio controls>
                                                        ...
                                                        <source src="<?php echo base_url() . "uploads/" . $row['src'] ?>" type="audio/mpeg">
                                                ...
                                                <td>
                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        <a href="<?php echo base_url() ?>admin/audio/editstory/<?php echo $row['id'] ?>" class="btn btn-primary shadow btn-xs sharp mr-1 blogeditbtn"><i class="fa fa-pencil"></i></a>
