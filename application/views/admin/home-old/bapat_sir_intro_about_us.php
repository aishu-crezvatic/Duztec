            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title">Edit About Bapat sir</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <form method="POST" action="<?php echo base_url() ?>admin/bapat_sir_intro_about_us/edit" enctype="multipart/form-data">

                            <div class="form-group">

                                <input name="id" type="text" value="1" id="editModalId_about_bapat_sir" hidden>
                            ...
                            <div class="form-group border rounded p-2">
                                ...
                                <img style="width:100%;" id="bapat_sir_image" class="my-2 border rounded" src="http://localhost/wayam/uploads/1st.jpg" alt="banner">
                            ...
                            <div class="form-group border rounded p-2">
                                ...
                                <label class="text-black font-w500">Bapat Sir Name</label>

                                <div class="input-group mb-3">

                                    <div class="custom-file">

                                        <input name="title" type="text" class="form-control" id="bapat_sir_name" required>
                            ...
                            <div class="form-group border rounded p-2">
                                ...
                                <label class="text-black font-w500">About Bapat Sir About Us</label>

                                <div class="input-group mb-3">

                                    <div class="custom-file">

                                        <input name="description" type="textarea" class="form-control" id="editAboutBapatSir" required>
            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <h4 class="card-title">About Shrikant Bapat Sir About Us Page</h4>
                                        ...
                                        ?>
                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td>
                                                    ...
                                                    <img style="width: 200px;" class="bapat_sir_image_class" src="<?php echo base_url() ."assets/images/others/". $row['bapat_sir_image'] ?>" alt="bapat_sir_image">

                                                </td>
                                               
                                                <td>
                                                    <p style="width: 200px;" class="bapat_sir_name" wtitle="<?php echo  $row['bapat_sir_name']?>"  ><?php echo  $row['bapat_sir_name']?> <p>
                                                </td>
                                                <td>
                                                    <p style="width: 200px;" class="bapat_sir_description" wdescription="<?php echo  $row['about_bapat_sir']?>"  ><?php echo  $row['about_bapat_sir']?> <p>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        <a href="javascript:void(0)" data-toggle="modal" data-target="#editOrderModalside" data-id="<?php echo $row['id'] ?>" class="btn btn-primary shadow btn-xs sharp mr-1 about_bapat_sir_editbtn123"><i class="fa fa-pencil"></i></a>

                                                        <!-- <a href="javascript:void(0)" data-toggle="modal" data-target="#deleteOrderModalside" data-id="<?php echo $row['id'] ?>" class="btn btn-danger shadow btn-xs sharp about_bapat_sir_editbtn"><i class="fa fa-trash"></i></a> -->
