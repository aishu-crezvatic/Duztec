    ...
    <div class="container-fluid">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form method="POST" action="<?php echo base_url() ?>admin/bb_compitation_faq/create" enctype="multipart/form-data">

                            <div class="form-group border rounded p-2">

                                <label class="text-black font-w500">Question</label>
                            ...
                            <div class="form-group border rounded p-2">
                                ...
                                <label class="text-black font-w500">Answer</label>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form method="POST" action="<?php echo base_url() ?>admin/bb_compitation_faq/edit" enctype="multipart/form-data">

                            <div class="form-group">

                                <input name="id" type="text" value="1" id="editModalFAQ" hidden>
                            ...
                            <div class="form-group border rounded p-2">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <div class="custom-file">
                                        ...
                                        <input name="question" type="text" class="form-control" id="editModalQuestion" required>
                            ...
                            <div class="form-group border rounded p-2">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <div class="custom-file">
                                        ...
                                        <input name="answer" type="text" class="form-control" id="editModalAnswer" required>
        ...
        <div class="modal fade" id="deleteOrderModalside">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                <div class="modal-content">
                    ...
                    <form method="POST" action="<?php echo base_url() ?>admin/bb_compitation_faq/delete" enctype="multipart/form-data">
                        <div class="modal-body">
                            <input name="id" type="text" value="1" id="deleteModalIdFAQ" hidden>
                            <div class="form-group">
        ...
        <div class="row">
            ...
            <div class="col-12 mb-3">
                <a href="javascript:void(0)" class="btn btn-primary w-100 m-0" data-toggle="modal" data-target="#addOrderModalside">+ Add new FAQ </a>
            </div>
            <div class="col-12">
                                ...
                                <table id="example3" class="display min-w850 dataTable no-footer" role="grid" aria-describedby="example3_info">
                                    ...
                                    <thead>
                                        ...
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="example3" rowspan="1" colspan="1" aria-label="Department: activate to sort column ascending" style="width: 182.703px;">Question</th>

                                            <th class="sorting" tabindex="0" aria-controls="example3" rowspan="1" colspan="1" aria-label="Department: activate to sort column ascending" style="width: 182.703px;">Answer</th>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr role="row" class="odd">
                                                ...
                                                <td><?php echo $i; ?></td>
                                                <td> 
                                                    <p style="width: 200px;" class="question_class" question="<?php echo  $row['question'] ?>" alt="question"><?php echo  $row['question'] ?>
                                                    <p> 
                                                </td>
                                                <td> 
                                                    <p style="width: 200px;" class="answer_class" answer="<?php echo  $row['answer'] ?>" alt="answer"><?php echo  $row['answer'] ?>
                                                    <p> 
                                                </td> 
                                                ...
                                                <td>
                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        <a href="javascript:void(0)" data-toggle="modal" data-target="#editOrderModalside" data-id="<?php echo $row['id'] ?>" class="btn btn-primary shadow btn-xs sharp mr-1 FAQeditbtn"><i class="fa fa-pencil"></i></a>

                                                        <a href="javascript:void(0)" data-toggle="modal" data-target="#deleteOrderModalside" data-id="<?php echo $row['id'] ?>" class="btn btn-danger shadow btn-xs sharp FAQdeletebtn"><i class="fa fa-trash"></i></a>
