            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title">Edit About Wayam</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <form method="POST" action="<?php echo base_url() ?>admin/about_aboutus_page/edit" enctype="multipart/form-data">
                            ...
                            <div class="form-group border rounded p-2">
                                ...
                                <img style="width:100%;" id="about_wayam_image" class="my-2 border rounded" src="http://localhost/wayam/uploads/1st.jpg" alt="banner">
                            ...
                            <div class="form-group border rounded p-2">
                                ...
                                <label class="text-black font-w500">About Wayam Description</label>
        ...
        <div class="modal fade" id="deleteOrderModalside">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                <div class="modal-content">
                    ...
                    <form method="POST" action="<?php echo base_url() ?>admin/about_aboutus_page/delete" enctype="multipart/form-data">
                        <div class="modal-body">
            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <h4 class="card-title">About Wayam about us page Table</h4>
