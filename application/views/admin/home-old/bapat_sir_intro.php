            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form method="POST" action="<?php echo base_url() ?>admin/bapat_sir_intro/edit" enctype="multipart/form-data">
                            ...
                            <div class="form-group border rounded p-2">
                                ...
                                <label class="text-black font-w500">About Bapat Sir</label>
        ...
        <div class="modal fade" id="deleteOrderModalside">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                <div class="modal-content">
                    ...
                    <form method="POST" action="<?php echo base_url() ?>admin/bapat_sir_intro/delete" enctype="multipart/form-data">
                        <div class="modal-body">
            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <h4 class="card-title">About Shrikant Bapat Sir Home Page</h4>
