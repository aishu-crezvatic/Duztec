    ...
    <div class="container-fluid">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form method="POST" action="<?php echo base_url() ?>admin/award/create" enctype="multipart/form-data">

                            <div class="form-group border rounded p-2">

                                <label class="text-black font-w500">Upload Image Award</label>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title">Edit award detail</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <form method="POST" action="<?php echo base_url() ?>admin/award/edit" enctype="multipart/form-data">

                            <div class="form-group">

                                <input name="id" type="text" value="1" id="editModalIdAward" hidden >
                            ...
                            <div class="form-group border rounded p-2">
                                ...
                                <img style="width:100%;" id="image" class="my-2 border rounded" src="http://localhost/wayam/uploads/1st.jpg" alt="banner">
                            ...
                            <div class="form-group border rounded p-2">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <div class="custom-file">
                                        ...
                                        <input name="title" type="text" class="form-control" id="editModalTitle" required>
                            ...
                            <div class="form-group border rounded p-2">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <div class="custom-file">
                                        ...
                                        <input name="desc" type="text" class="form-control" id="editModalDescription" required>
        ...
        <div class="modal fade" id="deleteOrderModalside">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                <div class="modal-content">
                    ...
                    <form method="POST" action="<?php echo base_url() ?>admin/award/delete" enctype="multipart/form-data">
                        <div class="modal-body">
                            <input name="id" type="text" value="1" id="deleteModalIdAward" hidden>
                            <div class="form-group">
        ...
        <div class="row">
            ...
            <div class="col-12 mb-3">
                <a href="javascript:void(0)" class="btn btn-primary w-100 m-0" data-toggle="modal" data-target="#addOrderModalside">+ Add new Award </a>
            </div>
            <div class="col-12">
                                        ...
                                        ?>
                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td>
                                                    ...
                                                    <img style="width: 200px;" class="image_class" src="<?php echo base_url() . "assets/images/awards/" . $row['image'] ?>" alt="banner">
                                                ...
                                                <td>
                                                    ...
                                                    <p style="width: 200px;" class="title" title="<?php echo  $row['title'] ?>" alt="title"><?php echo  $row['title'] ?>
                                                    <p>

                                                </td>
                                                <td>

                                                    <p style="width: 200px;" class="description" description="<?php echo  $row['description'] ?>" alt="description"><?php echo  $row['description'] ?>
                                                    <p>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        <a href="javascript:void(0)" data-toggle="modal" data-target="#editOrderModalside" data-id="<?php echo $row['id'] ?>" class="btn btn-primary shadow btn-xs sharp mr-1 awardeditbtn"><i class="fa fa-pencil"></i></a>

                                                        <a href="javascript:void(0)" data-toggle="modal" data-target="#deleteOrderModalside" data-id="<?php echo $row['id'] ?>" class="btn btn-danger shadow btn-xs sharp awarddeletebtn"><i class="fa fa-trash"></i></a>
...
<!-- <script>
    $(".switchSlider").click(function() {
        ...
        $.post(
            ...
            base_url + "admin/award/status/" + id, {
