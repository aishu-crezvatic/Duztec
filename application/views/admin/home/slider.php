    ...
    <div class="container-fluid">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form method="POST" action="<?php echo base_url() ?>admin/slider/create" enctype="multipart/form-data">
                            ...
                            <div class="form-group border rounded p-2">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <div class="custom-file">
                                        ...
                                        <input name="image0" type="file" class="custom-file-input" accept=".jpg,.jpeg,.png,.webp,.avif" required>
                            ...
                            <div class="form-group border rounded p-2">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <div class="custom-file">
                                        ...
                                        <input name="image1" type="file" class="custom-file-input" accept=".jpg,.jpeg,.png,.webp,.avif" required>
                            ...
                            <div class="form-group border rounded p-2">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <div class="custom-file">
                                        ...
                                        <input name="image2" type="file" class="custom-file-input" accept=".jpg,.jpeg,.png,.webp,.avif" required>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form method="POST" action="<?php echo base_url() ?>admin/slider/edit" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-12 mb-3">
                ...
                <a href="javascript:void(0)" class="btn btn-primary w-100 m-0" data-toggle="modal" data-target="#addOrderModalside">+ New Slider</a>
                                ...
                                <table id="example3" class="display min-w850 dataTable no-footer" role="grid" aria-describedby="example3_info">
                                    ...
                                    <thead>
                                        ...
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="example3" rowspan="1" colspan="1" aria-label="Department: activate to sort column ascending" style="width: 182.703px;">Laptop Banner</th>

                                            <th class="sorting" tabindex="0" aria-controls="example3" rowspan="1" colspan="1" aria-label="Department: activate to sort column ascending" style="width: 182.703px;">Tablet Banner</th>
                                        ...
                                        ?>
                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td>
                                                    ...
                                                    <img style="width: 200px;" class="LaptopBanner" src="<?php echo base_url() ."uploads/". $row['lp_banner'] ?>" alt="banner">

                                                </td>

                                                <td>

                                                    <img style="width: 200px;" class="TabletBanner" src="<?php echo base_url() ."uploads/". $row['tb_banner'] ?>" alt="banner">

                                                </td>

                                                <td>

                                                    <img style="width: 200px;" class="MobileBanner" src="<?php echo base_url() ."uploads/". $row['mb_banner'] ?>" alt="banner">
                                                ...
                                                <td>
                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        <a href="javascript:void(0)" data-toggle="modal" data-target="#editOrderModalside" data-id="<?php echo $row['id'] ?>" class="btn btn-primary shadow btn-xs sharp mr-1 editbtn"><i class="fa fa-pencil"></i></a>

                                                        <a href="javascript:void(0)" data-toggle="modal" data-target="#deleteOrderModalside" data-id="<?php echo $row['id'] ?>" class="btn btn-danger shadow btn-xs sharp deletebtn"><i class="fa fa-trash"></i></a>
