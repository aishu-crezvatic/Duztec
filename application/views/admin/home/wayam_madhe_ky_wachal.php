            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form method="POST" action="<?php echo base_url() ?>admin/wayam_madhe_ky_wachal/edit" enctype="multipart/form-data">
                            ...
                            <div class="form-group border rounded p-2">
                                ...
                                <img style="width:100%;" id="wayam_madhe_kay_wachal_image" class="my-2 border rounded" src="http://localhost/wayam/uploads/1st.jpg" alt="banner">
            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <h4 class="card-title">Wayam madhe Kay wachal table</h4>
                                        ...
                                        ?>
                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td>
                                                    ...
                                                    <img style="width: 200px;" class="wayam_madhe_kay_wachal_image_class" src="<?php echo base_url() ."assets/images/logo/". $row['kywachal_image'] ?>" alt="banner">
                                                ...
                                                <td>
                                                    ...
                                                    <p style="width: 200px;" class="kywachal_title" wtitle="<?php echo  $row['kywachal_title']?>"  alt="banner"><?php echo  $row['kywachal_title']?> <p>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        <a href="javascript:void(0)" data-toggle="modal" data-target="#editOrderModalside" data-id="<?php echo $row['id'] ?>" class="btn btn-primary shadow btn-xs sharp mr-1 weditbtn"><i class="fa fa-pencil"></i></a>

                                                        <a href="javascript:void(0)" data-toggle="modal" data-target="#deleteOrderModalside" data-id="<?php echo $row['id'] ?>" class="btn btn-danger shadow btn-xs sharp wdeletebtn"><i class="fa fa-trash"></i></a>
