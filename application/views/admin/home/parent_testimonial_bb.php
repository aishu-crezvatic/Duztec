            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form method="POST" action="<?php echo base_url() ?>admin/parent_testimonial_bb/create" enctype="multipart/form-data">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title">Edit parent testimonial</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <form method="POST" action="<?php echo base_url() ?>admin/parent_testimonial_bb/edit" enctype="multipart/form-data">
        ...
        <div class="modal fade" id="deleteOrderModalside">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                <div class="modal-content">
                    ...
                    <form method="POST" action="<?php echo base_url() ?>admin/parent_testimonial_bb/delete" enctype="multipart/form-data">
                        <div class="modal-body">
            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <h4 class="card-title">Parent testimonial table</h4>
