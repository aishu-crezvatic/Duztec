    ...
    <div class="container-fluid">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title">Add Salagar</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <form method="POST" action="<?php echo base_url() ?>admin/salagar_mandal/create" enctype="multipart/form-data">

                            <div class="form-group border rounded p-2">

                                <label class="text-black font-w500">Upload Image salagar</label>
                            ...
                            <div class="form-group border rounded p-2">
                                ...
                                <label class="text-black font-w500">salagar title</label>
                            ...
                            <div class="form-group border rounded p-2">
                                ...
                                <label class="text-black font-w500">salagar description</label>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title">Edit salagar detail</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <form method="POST" action="<?php echo base_url() ?>admin/salagar_mandal/edit" enctype="multipart/form-data">
                            ...
                            <div class="form-group border rounded p-2">
                                ...
                                <label class="text-black font-w500">Upload Image for salagar</label>

                                <img style="width:100%;" id="salagar_image" class="my-2 border rounded" src="http://localhost/wayam/uploads/1st.jpg" alt="banner">
                            ...
                            <div class="form-group border rounded p-2">
                                ...
                                <label class="text-black font-w500">Salagar Mandal Title</label>

                                <div class="input-group mb-3">

                                    <div class="custom-file">

                                        <input name="title" type="text" class="form-control" id="editModalTitleSalagar" required>
                            ...
                            <div class="form-group border rounded p-2">
                                ...
                                <label class="text-black font-w500">Salagar Mandal Description</label>

                                <div class="input-group mb-3">

                                    <div class="custom-file">

                                        <input name="desc" type="text" class="form-control" id="editModalDescSalagar" required>
        ...
        <div class="modal fade" id="deleteOrderModalside">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                <div class="modal-content">
                    ...
                    <form method="POST" action="<?php echo base_url() ?>admin/salagar_mandal/delete" enctype="multipart/form-data">
                        <div class="modal-body">
                            <input name="id" type="text" value="1" id="deleteModalIdSalagar" hidden>
                            <div class="form-group">
        ...
        <div class="row">
            ...
            <div class="col-12 mb-3">
                <a href="javascript:void(0)" class="btn btn-primary w-100 m-0" data-toggle="modal" data-target="#addOrderModalside">+ Add new salagar </a>
            </div>
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <h4 class="card-title">Salagar mandal table</h4>
                                        ...
                                        ?>
                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td>
                                                    ...
                                                    <img style="width: 200px;" class="salagar_image_class" src="<?php echo base_url() . "assets/images/advisor/" . $row['salagar_image'] ?>" alt="banner">
                                                ...
                                                <td>
                                                    ...
                                                    <p style="width: 200px;" class="salagar_title" wtitle="<?php echo  $row['salagar_title'] ?>" alt="salagar_title"><?php echo  $row['salagar_title'] ?>
                                                    <p>

                                                </td>
                                                <td>

                                                    <p style="width: 200px;" class="salagar_desc" wdesc="<?php echo  $row['salagar_desc'] ?>" alt="salagar_desc"><?php echo  $row['salagar_desc'] ?>
                                                    <p>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        <a href="javascript:void(0)" data-toggle="modal" data-target="#editOrderModalside" data-id="<?php echo $row['id'] ?>" class="btn btn-primary shadow btn-xs sharp mr-1 salagareditbtn"><i class="fa fa-pencil"></i></a>

                                                        <a href="javascript:void(0)" data-toggle="modal" data-target="#deleteOrderModalside" data-id="<?php echo $row['id'] ?>" class="btn btn-danger shadow btn-xs sharp salagardeletebtn"><i class="fa fa-trash"></i></a>
