						...
						<div class="service-single-box">
							<div class="service-icon">
								<!-- <img src="assets/images/. $category['category_image']);" alt="Icon"> -->
                                                            ...
                                                            <img src="<?php echo base_url('uploads/product/image/'.$images_array[0]); ?>" alt="Icon">
							</div>
							<div class="service-content">
								<h2><?php echo $product['name']; ?></h2>
								<p><?php echo $product['cat_description']; ?></p>
								<a href="<?php echo base_url() .'product_detail/'. $product['p_id']; ?>">Read More <i class="fas fa-long-arrow-alt-right"></i></a>
							</div>
						</div>
					</div>
