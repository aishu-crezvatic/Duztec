			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-12">
					...
					<div class="single-content">
						<h2>PROJECT NAME : <span>Vegetables Growing Farm</span></h2>
						<h2>Client : <span class="ml2">Vegetables Lover</span></h2>
						<h2>Category : <span class="ml3">Fruits & vegetables</span></h2>
						<h2>Delivery Mode : <span class="ml4">Stipulated Price</span></h2>
						<h2>Location : <span class="ml5">USA</span></h2>
						<h2>SHARE : <span class="ml6">
