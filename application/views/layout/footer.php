		...
		<div class="row align-items-center">
			...
			<div class="col-lg-6 col-md-6">
				<div class="footer-menu-right">
					<ul>
						<li><a href="<?php echo base_url() . 'term-and-condition'; ?>">Term & conditions</a></li>
						<li><a class="br-none" href="<?php echo base_url() . 'privacy-and-policy'; ?>">Privacy
								Policy</a>
						</li>
					</ul>
				</div>
...
<div id="cookieNotice">
	<div class="cookie-notice"><span class="cookie">🍪</span>
		<p>This website uses cookies or similar technologies, to enhance your browsing experience and provide
			personalized recommendations. </br> By continuing to use our website, you agree to our <a
				style="color:#115cfa;" href="<?php echo base_url(); ?>privacy-and-policy">Privacy Policy</a></br><button
				class="btn-primary" style="float: right;" onclick="acceptCookieConsent();">Accept</button>
	</div>
</div>
<!--Cookie End-->
